...
from src.exporters.about.insight_genie_exporter import FILE_NAME, InsightGenieExporter
from src.exporters.exporter import DATA_DIR, DATA_FILE_PREFIX


@pytest.fixture(name="exporter")
def build_exporter():
    return InsightGenieExporter()


@patch("src.exporters.about.insight_genie_exporter.create_dir")
@patch("src.exporters.about.insight_genie_exporter.does_data_exist")
...
@patch("src.exporters.about.insight_genie_exporter.shutil")
